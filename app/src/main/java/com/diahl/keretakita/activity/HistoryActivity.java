...
import com.diahl.keretakita.adapter.HistoryAdapter;
import com.diahl.keretakita.database.DatabaseHelper;
import com.diahl.keretakita.model.HistoryModel;
...
public class HistoryActivity extends AppCompatActivity {
    ...
    String id_book = "", asal, tujuan, tanggal, waktu, dewasa, anak, riwayat, total;
    String email;
    TextView tvNotFound;
    ...
    public void refreshList() {
        ...
        for (int i = 0; i < cursor.getCount(); i++) {
            ...
            riwayat = "Berhasil melakukan booking untuk melakukan perjalanan dari " + asal + " menuju " + tujuan + " pada tanggal " + tanggal + " waktu " + waktu + " . Jumlah pembelian tiket dewasa sejumlah " + dewasa + " dan tiket anak-anak sejumlah " + anak + ".";
            hasil.add(new HistoryModel(id_book, tanggal, waktu, riwayat, total, R.drawable.profile));
        }

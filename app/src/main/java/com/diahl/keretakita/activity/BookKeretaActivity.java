...
public class BookKeretaActivity extends AppCompatActivity {
    ...
    String email;
    int id_book;
    public String sAsal, sTujuan, sTanggal, sDewasa, sAnak, sWaktu;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final String[] waktu = {"07.00", "09.00", "11.00", "13.00", "15.00", "17.00", "19.00", "21.00"};
                        ...
                        AlertDialog dialog = new AlertDialog.Builder(BookKeretaActivity.this)
                                ...
                                .setPositiveButton("Ya", new DialogInterface.OnClickListener() {
                                    ...
                                    public void onClick(DialogInterface dialog, int which) {
                                        try {
                                            db.execSQL("INSERT INTO TB_BOOK (asal, tujuan, tanggal, dewasa, anak, waktu) VALUES ('" +
                                                    sAsal + "','" +
                                                    sTujuan + "','" +
                                                    sTanggal + "','" +
                                                    sDewasa + "','" +
